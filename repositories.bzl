...
def go_repositories():
    ...
    go_repository(
        ...
        sum = "h1:huxqepDufQpLLIRXiVkTvnxrzJlpwmIWAObmcCcUFr0=",
        version = "v0.0.0-20221005025214-4161e89ecf1b",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:AzgQNqF+FKwyQ5LbVrVqOcuuFB67N47F9+htZYH0wFM=",
        version = "v0.0.0-20221006211917-84dc82d7e875",
    )
    go_repository(
